...
<head>
    ...
    <title>Pay &ndash; Z1KneeBrace</title>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 sm-margin-30px-bottom">
                        <div class="create-ac-content bg-light-gray padding-20px-all">
                            <div style="float:right">
                                <button class="btn" id="rzp-button1" value="Place order" type="submit">Place
                                    order</button>
                            </div>
                           ...
                           ?>
                            ...
                            <div class="row p-4">
                                ...
                                <div style="float:right" class="ml-3">
                                    <a class="btn" href="../index.php" id="rzp-button1" value="Place order"
                                        type="submit">back to shopping</a>
                                </div>
