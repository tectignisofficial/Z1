...
if(!empty($fileNames)){
    ...
    foreach ($_FILES["myfile"]["error"] as $key => $error) {
        ...
        if ($error == UPLOAD_ERR_OK) {
            ...
            $images_name =$images_name.",".$filename;
                $sql2=mysqli_query($conn,"INSERT INTO `product_image`(`name`, `image`) VALUES ('$pname','$filename')");
    ...
    if($sql==1){
        echo '<script>alert("Update sucessfully submitted"7);</script>';
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="editUserForm" method="post" class="row gy-1 pt-75">
                        <div class="col-12 col-md-12">
                            ...
                            <input type="text" id="updaterate" name="updaterate" class="form-control" placeholder="Rate"
                                value="<?php echo $arr['stock'] ?>" />
                        </div>
                        <div class="col-12 text-center mt-2 pt-50">
                            <button type="submit" name="updatecurrrency" id="updatecurrrency"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="name" class="form-control" name="name" placeholder="Name"
                                            value="<?php echo $editArr['products']; ?>" required />
                                    </div>
                                    <div class="mb-1">
                                        <label class="form-label" for="desc">Description</label>
                                        <div class="mt-2">
                                            <textarea class="summernote form-control"
                                                name="desc"><?php echo $editArr['description']; ?></textarea>
                                        </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="mt-2">
                                            <textarea class="summernote form-control"
                                                name="cont"><?php echo $editArr['content']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="mb-1">
                                        ...
                                        <div class="upload-btn-wrapper">
                                            <img src="image/product_image_check/<?php echo $editArr['hightlightfile']; ?>"
                                                alt="" width="50" height="50">
                                            <input type="hidden" name="hightlightfilehide"
                                                value="<?php echo $editArr['hightlightfile']; ?>">
                                            ...
                                            <input type="file" name="hightlightfile" id="hightlightfile"
                                                value="<?php echo $editArr['hightlightfile']; ?>" accept="image/webp" />
                                        </div>
                                        ...
                                        ?>
                                            ...
                                            <input type="hidden" name="myfilehide"
                                                value="<?php echo $editArr['image']; ?>">
                                            <button class="btn1 btn-outline-primary mb-1"><i data-feather="file"></i>
                                        ...
                                        <div class="upload-btn-wrapper">
                                            <img src="image/product_image_check/<?php echo $editArr['hoverfile']; ?>"
                                                alt="" width="50" height="50">
                                            <input type="hidden" name="hoverfilehide"
                                                value="<?php echo $editArr['hoverfile']; ?>">
                                            <button class="btn1 btn-outline-primary mb-1"><i data-feather="file"></i>
                                    ...
                                    <div class="upload-btn-wrapper">
                                        <img src="image/product_image_check/<?php echo $editArr['sizefile']; ?>" alt=""
                                            width="50" height="50">
                                        <input type="hidden" name="sizefilehide"
                                            value="<?php echo $editArr['sizefile']; ?>">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select name="stock" id="" class="form-control">
                                                <option value="In Stock"
                                                    <?php if($editArr['stock_status']=='In Stock'){ echo 'selected'; }?>>
                                                    In Stock</option>
                                                <option value="Out Of Stock"
                                                    <?php if($editArr['stock_status']=='Out Of Stock'){ echo 'selected'; }?>>
                                                    Out Of Stock</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-3">
                                                ...
                                                <input type="text" class="form-control" name="attrnal[]"
                                                    value="<?= $arr['value'] ?>" readonly>
                                            </div>
                                            <div class="col-3">
                                                <label class="form-label" for="csname">Stock</label>
                                                <input type="text" class="form-control" name="stock[]"
                                                    value="<?= $arr['stock'] ?>" readonly>
                                            </div>
                                            <div class="col-3 mt-2">
                                                <button type="button"
                                                    class="btn btn-icon rounded-circle btn-flat-primary btnmod1"
                                                    data-bs-toggle="modal" data-bs-target="#editUser<?= $arr['id'] ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" id="sedes" class="form-control" name="sedes"
                                                ...
                                                value="<?php echo $editArr['seo_description']; ?>" />
                                        </div>
                                    </div>
                                    <!-- </form> -->
                                </div>
                                        ...
                                        <div class="col-12">
                                            <select class="form-select" id="sbasicSelect" name="published"
                                                ...
                                                <option value="Published"
                                                    <?php if( $editArr['status'] == 'Published'){ echo 'selected'; } ?>>
                                                    Published</option>
                                                <option value="Draft"
                                                    <?php if( $editArr['status'] == 'Draft'){ echo 'selected'; } ?>>
                                                    Draft</option>
                                                <option value="Pending"
                                                    <?php if( $editArr['status'] == 'Pending'){ echo 'selected'; } ?>>
                                                    Pending</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check form-check-success form-switch">
                                                <input type="checkbox" value="1" class="form-check-input"
                                                    id="customSwitch4"
                                                    <?php if( $editArr['featured'] == '1'){ echo 'checked'; } ?>
                                                    name="featured" />
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="mb-1">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="tv" name="knee"
                                                        value="accessories"
                                                        <?php if( $editArr['categories'] == 'accessories'){ echo 'checked'; } ?> />
                                            ...
                                            <div class="mb-1">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="customCheck1"
                                                        ...
                                                        <?php if( $editArr['label'] == 'New'){ echo 'checked'; } ?> />
                                            ...
                                            <div class="mb-1">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="customCheck2"
                                                        ...
                                                        <?php if( $editArr['label'] == 'Hot'){ echo 'checked'; } ?> />
                                            ...
                                            <div class="mb-1">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="customCheck4"
                                                        ...
                                                        <?php if( $editArr['label'] == 'Sale'){ echo 'checked'; } ?> />
