...
$razorpay=mysqli_query($conn, "Select * from paymentmethod where name='razorpay'");
$arr=mysqli_fetch_array($razorpay);

if(isset($_POST['paypalUpdate'])){
$clientsecrete=$_POST['clientsecrete'];
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-3" align="center"><br>
                                                                    <svg version="1.1" id="Layer_1"
                                                                        ...
                                                                        x="0px" y="0px" width="180px" height="150px"
                                                                        viewBox="0 0 124 33"
	...
	l1.454-9.225L9.614,7.699z" />
                                                                ...
                                                                <div class="col-8 mt-3" style="margin-left:3%">
                                                                    <a href="https://paypal.com"
                                                                        target="_blank"><b>PayPal</b></a>
                                                                    <div class="row mt-1">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" align="right">
                                                            <button type="submit" class="btn btn-primary"
                                                                name="paypalUpdate">Update</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" align="right">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <button type="submit" class="btn btn-primary"
                                                                        name="razorpayUpdate">Update</button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
