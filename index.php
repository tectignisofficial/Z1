    ...
    <div id="page-content">
    	...
    	<div class="slideshow slideshow-wrapper pb-section sliderFull">
        	<div class="home-slideshow">
                ...
                <div class="slide">
                	<div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="assets/images/slideshow-banners/belle-banner2.jpg" src="assets/images/slideshow-banners/belle-banner2.jpg" alt="Summer Bikini Collection" title="" />
                        <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                            <div class="slideshow__text-content bottom">
                                <div class="wrap-caption center">
                ...
                <div class="hero__inner">
                    <div class="container">
                        <div class="wrap-text left text-small font-bold">
                            ...
                            <div class="rte-setting mega-subtitle">Customization is the key. In order to meet customer needs and satisfaction, customizing our healthcare products is necessary. One Size doesn’t fit all. Neither you nor us. Each and every customised Knee Braces are designed in such a unique way to fit you perfectly. Our custom Knee Braces are built to keep up with every move you make. We custom make your braces with durable materials and quality craftsmanship with extra protection and that proper support and comfort to ensure a speedy recovery.
